...
import { loadData, saveData, updateEntity, getEntity, addToEntity, updateItemInEntity, removeFromEntity, getScheduleForClass, saveScheduleForClass, getSelectedClass, setSelectedClass, importData, exportAllData } from './storage';
import { defaultClasses, defaultTeachers, defaultSubjects, defaultClassrooms } from './data';
